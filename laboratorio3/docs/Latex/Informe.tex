...
% variables
\newcommand{\doctitle}{Comunicación entre procesos:\\Método de Transferencia de mensajes}
\newcommand{\docauthor}{Milton Hernández M.}
\newcommand{\docnumber}{3}
\newcommand{\refnumber}{003}
\newcommand{\versionnumber}{1}
\newcommand{\revisionnumber}{1}
\newcommand{\changeregister}{1}
\newcommand{\doctype}{Práctica }
\newcommand{\docdate}{6 de Noviembre del 2024 }

...
int main(){
    ...
    printf("Filosofo 0 \t Filosofo 1 \t Filosofo 2 \t Filosofo 3 \t Filosofo 4 \n");
...
void printPhilosophers(){
    // Imprimir filosofos
    for(int i = 0; i < N; i++){
        switch (ProgramInfo.state[i])
        {
        case THINKING:
            printf(ANSI_COLOR_YELLOW "PENSANDO" ANSI_COLOR_RESET "\t");
            break;
        case HUNGRY:
            printf(ANSI_COLOR_RED "ESPERANDO" ANSI_COLOR_RESET "\t");
            break;
        case EATING:
            printf(ANSI_COLOR_GREEN "COMIENDO" ANSI_COLOR_RESET "\t");
            break;
        default:
            printf("ERROR\t");
        }

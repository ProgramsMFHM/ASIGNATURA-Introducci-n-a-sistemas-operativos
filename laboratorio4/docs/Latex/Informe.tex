...
% variables
\newcommand{\doctitle}{Sincronizacion de Procesos: El Problema de Los Filosofos Comensales}
\newcommand{\docauthor}{Milton Hernández M. y Ayrton Morrison R.}
\newcommand{\docnumber}{4}
\newcommand{\refnumber}{004}
\newcommand{\versionnumber}{1}
\newcommand{\revisionnumber}{1}
\newcommand{\changeregister}{1}
\newcommand{\doctype}{Práctica }
\newcommand{\docdate}{22 de Noviembre del 2024 }
\newcommand{\docyear}{2024}
\newcommand{\doctime}{8:00 AM}
...
\input{src/sections/Portada.tex}
\newpage

\input{src/tables/Registro.tex}
\newpage

\tableofcontents
\newpage

\input{src/sections/Resumen.tex}
\input{src/sections/introducción.tex}
\newpage

\input{src/sections/Objetivos.tex}
\input{src/sections/MarcoTeorico.tex}
\newpage

\input{src/sections/ProcedimientoExperimental.tex}
\newpage

\input{src/sections/DatosObtenidos.tex}
\newpage

\input{src/sections/Analisis.tex}
\newpage
